  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
              ...
              <select onChange={(e) => setSubCategory(e.target.value)} className='w-full px-3 py-2'>
                  ...
                  <option value="Sandles & Clogs">Sandles & Clogs</option>
        ...
        <div>
          ...
          <div className='flex gap-3'>
            <div onClick={()=>setSizes(prev => prev.includes("6") ? prev.filter( item => item !== "6") : [...prev,"6"])}>
              <p className={`${sizes.includes("6") ? "bg-pink-100" : "bg-slate-200" } px-3 py-1 cursor-pointer`}>6</p>
            </div>
            ...
            <div onClick={()=>setSizes(prev => prev.includes("12") ? prev.filter( item => item !== "12") : [...prev,"12"])}>
              <p className={`${sizes.includes("12") ? "bg-pink-100" : "bg-slate-200" } px-3 py-1 cursor-pointer`}>12</p>
            </div>
          </div>
        </div>
        ...
        <div className='flex gap-2 mt-2'>
          ...
          <label className='cursor-pointer' htmlFor="bestseller">Add to TRENDSETTERS' CHOICE</label>
        </div>

        <button type="submit" className='bg-black text-white text-xs px-10 py-4 rounded-lg transition-colors duration-300 hover:bg-[#356699]'>ADD</button>
